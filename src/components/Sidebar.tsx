...
export const Sidebar = ({ onNavigate, currentView }: SidebarProps) => {
  ...
  return (
    <div className="w-64 bg-white border-r border-zinc-100 flex flex-col h-full">
      {/* Main Navigation */}
        ...
        <div className="mt-5 space-y-3">
          {playlists.map((playlist) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-2 rounded-xl transition-all text-left truncate ${
            ...
            >
              ...
              <div className="flex flex-col gao-y-2">
                <h1 className="text-md truncate">{playlist.name}</h1>
